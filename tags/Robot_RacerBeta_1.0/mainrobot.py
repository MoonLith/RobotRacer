...
while (vitesse_noir < 1300) or (vitesse_noir > 2500) and ((vitesse_rouge < 1300) or (vitesse_rouge > 2500)) :
    vitesse_noir = input("Veuillez entrer une vitesse pour la couleur noir : (comprise entre 1300 & 2500)")
    vitesse_rouge = input("Veuillez entrer une vitesse pour la couleur rouge : (comprise entre 1300 & 2500)")
